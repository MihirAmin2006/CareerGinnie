  ...
  return `
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
      ...
      <div class="bg-white rounded-lg shadow-md p-6">
        <h2 class="text-xl font-bold text-gray-800 mb-4">Resume Builder</h2>
        <p class="text-gray-600 mb-6">Create a professional resume with our AI-powered builder</p>
        
        <div class="space-y-4">
          <button id="create-resume-btn" class="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 rounded-md transition duration-300">
            Create New Resume
          </button>
          <button id="edit-resume-btn" class="w-full bg-white border border-indigo-600 text-indigo-600 hover:bg-indigo-50 py-2 px-4 rounded-md transition duration-300">
